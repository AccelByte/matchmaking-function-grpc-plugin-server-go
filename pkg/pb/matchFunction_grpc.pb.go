...
func (UnimplementedMatchFunctionServer) GetStatCodes(context.Context, *GetStatCodesRequest) (*StatCodesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStatCodes not implemented")
}
...
func (UnimplementedMatchFunctionServer) EnrichTicket(context.Context, *EnrichTicketRequest) (*EnrichTicketResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EnrichTicket not implemented")
}
func (UnimplementedMatchFunctionServer) MakeMatches(grpc.BidiStreamingServer[MakeMatchesRequest, MatchResponse]) error {
	return status.Error(codes.Unimplemented, "method MakeMatches not implemented")
}
func (UnimplementedMatchFunctionServer) BackfillMatches(grpc.BidiStreamingServer[BackfillMakeMatchesRequest, BackfillResponse]) error {
	return status.Error(codes.Unimplemented, "method BackfillMatches not implemented")
}
